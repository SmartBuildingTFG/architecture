...
Como ejemplo se desarrollarán algunos Controllers, para hacer uso y alimenta a la API.
...
IBuilding puede ser visto como un servicio de integración que ofrezca datos sobre los edificio a aplicaciones
terceras. Por ello es conveniente que se use una interfaz de datos estándar que sea reconocida 
e implementada fácilmente por terceros.

La tecnología de Fiware ofrece la interfaz NGSI-LD, que está reconocida por diferentes organismo importantes y
se pretende que sea la de referencia en toda la Unión Europea. 

Fiware deja abierta la posiblidad de implementar otras interfaces que se usan en desarrollo de dispositivos
IoT como UltraLight 2.0 o la ofrecida por OneM2M, que también se considera un estándar reconocido por organismos
como la ETSI.
