...
El desarrollo de una plataforma virtual común que permita interconectar cualquier elemento 
integrable a la red de Internet (dispositivos IoT) que se encuentren en un edificio (Smart Building)
...
IBuilding dispondrá de un servidor central (DataBuilding) que, usando la tecnología
